...
class TriqsSolver:
    ...
    dlr_symmetrize : bool, optional
        Use a symmetric DLR grid (default: `False`)
    ...
    def __init__(
        ...
        self.dmesh = MeshDLR(
            beta=beta, statistic='Fermion', eps=eps, w_max=w_max,
        ...
        self.S = Solver(
            ...
            dlr_symmetrize=dlr_symmetrize, verbose=verbose)
